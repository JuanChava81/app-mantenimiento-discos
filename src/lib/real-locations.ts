...
const RAW_LOCATIONS: [string, string, string, number[]][] = [
  ...
  ["D 02", "Agraciada", "Av. Agraciada 2986", [3, 9]],
  ["D 03", "Arenal Grande", "Arenal Grande 1376", [1, 7]],
  ["D 04", "Legrand", "Av. Legrand 5085", [2, 8]],
  ["D 05", "Parada 5", "Pedragosa Sierra y Av. Italia, Punta del Este", [5, 12]],
  ["D 06", "Fernandez Crespo", "Av. Daniel Fernandez Crespo 1727", [3, 9]],
  ["D 07", "Soca", "Av. Dr. Francisco Soca 1318", [3, 9]],
  ...
  ["D 10", "Camino Maldonado", "Brig. Gral. Lavalleja 7722, Maldonado", [3, 9]],
  ...
  ["D 18", "Solymar", "Av. Giannattasio Km. 23.500, Solymar", [2, 8]],
  ["D 19", "Atlantida", "Calle Gral. Artigas s/n, entre 22 y 24, Atlántida", [1, 8]],
  ["D 20", "20 De Setiembre", "20 de setiembre 1521", [3, 9]],
  ["D 21", "Ejido", "Ejido 1530", [1, 7]],
  ["D 22", "Barrios Amorin", "Barrios Amorín 859", [1, 7]],
  ["D 23", "Medanos", "Av. Giannattasio km 27.500 y Av. Central, Médanos", [2, 9]],
  ["D 24", "Obligado", "Obligado 968", [3, 9]],
  ...
  ["D 28", "La Cabaña", "Naciones Unidas y Rambla, El Pinar", [2, 9]],
  ["DV 01", "Malvin", "H. Irigoyen 1444", [5, 11]],
  ["DV 02", "Punta Gorda", "Gral. Paz 1404", [6, 12]],
  ["DV 03", "Brisas", "Rivera 4502", [1, 7]],
  ["DV 04", "Carrasco", "Bolivia 1413", [2, 8]],
  ["DV 05", "Shangrila", "Av. Calcagno s/n, Shangrilá", [3, 8]],
  ...
  ["DV 15", "Agraciada", "Agraciada y Fco. Gómez", [2, 8]],
  ["DV 16", "San Martín II", "Av. Gral. San Martín 3083", [5, 10]],
  ["DV 18", "Las Piedras I", "Juan A. Lavalleja 671", [2, 8]],
  ...
  ["DV 22", "26 de Marzo", "26 de Marzo esq. Lorenzo Pérez", [2, 8]],
  ["DV 23", "Coronel Mora", "Coronel Mora y Agr. Francisco Ros", [3, 9]],
  ["DV 24", "San Quintín", "Av. San Quintín 4376", [1, 7]],
  ["DV 25", "Las Piedras II", "Av. Dr. Pouey 622", [2, 8]],
];
