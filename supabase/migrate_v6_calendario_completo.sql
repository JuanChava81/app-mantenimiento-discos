-- Migración v6: completar el calendario de visitas con Agosto y
-- Setiembre (las 18 sucursales que en migrate_v5 habían quedado con un
-- solo mes confirmado). Con esto las 52 sucursales quedan con sus 2
-- visitas del año. Correr una sola vez en el SQL Editor de Supabase.
-- Si nunca corriste migrate_v5, no pasa nada: este UPDATE deja el valor
-- final correcto para las 52 igual, no hace falta correr los dos.
