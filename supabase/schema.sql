...
-- 18 locales que hoy tienen un solo mes van a sumar el segundo ahí.
insert into locations (suc, chain, name, address, months) values
('D 01', 'Disco', 'Scoseria', 'Scosería 2628', '{6,12}'),
('D 02', 'Disco', 'Agraciada', 'Av. Agraciada 2986', '{3}'),
('D 03', 'Disco', 'Arenal Grande', 'Arenal Grande 1376', '{1,7}'),
('D 04', 'Disco', 'Legrand', 'Av. Legrand 5085', '{2}'),
('D 05', 'Disco', 'Parada 5', 'Pedragosa Sierra y Av. Italia, Punta del Este', '{5,12}'),
('D 06', 'Disco', 'Fernandez Crespo', 'Av. Daniel Fernandez Crespo 1727', '{3}'),
('D 07', 'Disco', 'Soca', 'Av. Dr. Francisco Soca 1318', '{3}'),
...
('D 10', 'Disco', 'Camino Maldonado', 'Brig. Gral. Lavalleja 7722, Maldonado', '{3}'),
...
('D 18', 'Disco', 'Solymar', 'Av. Giannattasio Km. 23.500, Solymar', '{2}'),
('D 19', 'Disco', 'Atlantida', 'Calle Gral. Artigas s/n, entre 22 y 24, Atlántida', '{1}'),
('D 20', 'Disco', '20 De Setiembre', '20 de setiembre 1521', '{3}'),
('D 21', 'Disco', 'Ejido', 'Ejido 1530', '{1,7}'),
('D 22', 'Disco', 'Barrios Amorin', 'Barrios Amorín 859', '{1,7}'),
('D 23', 'Disco', 'Medanos', 'Av. Giannattasio km 27.500 y Av. Central, Médanos', '{2}'),
('D 24', 'Disco', 'Obligado', 'Obligado 968', '{3}'),
...
('D 28', 'Disco', 'La Cabaña', 'Naciones Unidas y Rambla, El Pinar', '{2}'),
('DV 01', 'Devoto', 'Malvin', 'H. Irigoyen 1444', '{5,11}'),
('DV 02', 'Devoto', 'Punta Gorda', 'Gral. Paz 1404', '{6,12}'),
('DV 03', 'Devoto', 'Brisas', 'Rivera 4502', '{1,7}'),
('DV 04', 'Devoto', 'Carrasco', 'Bolivia 1413', '{2}'),
('DV 05', 'Devoto', 'Shangrila', 'Av. Calcagno s/n, Shangrilá', '{3}'),
...
('DV 15', 'Devoto', 'Agraciada', 'Agraciada y Fco. Gómez', '{2}'),
('DV 16', 'Devoto', 'San Martín II', 'Av. Gral. San Martín 3083', '{5,10}'),
('DV 18', 'Devoto', 'Las Piedras I', 'Juan A. Lavalleja 671', '{2}'),
...
('DV 22', 'Devoto', '26 de Marzo', '26 de Marzo esq. Lorenzo Pérez', '{2}'),
('DV 23', 'Devoto', 'Coronel Mora', 'Coronel Mora y Agr. Francisco Ros', '{3}'),
('DV 24', 'Devoto', 'San Quintín', 'Av. San Quintín 4376', '{1,7}'),
('DV 25', 'Devoto', 'Las Piedras II', 'Av. Dr. Pouey 622', '{2}');
