...
-- Calendario de visitas completo, confirmado mes a mes contra el Excel
-- real: los 12 meses del año, 2 visitas por local.
insert into locations (suc, chain, name, address, months) values
('D 01', 'Disco', 'Scoseria', 'Scosería 2628', '{6,12}'),
('D 02', 'Disco', 'Agraciada', 'Av. Agraciada 2986', '{3,9}'),
('D 03', 'Disco', 'Arenal Grande', 'Arenal Grande 1376', '{1,7}'),
('D 04', 'Disco', 'Legrand', 'Av. Legrand 5085', '{2,8}'),
('D 05', 'Disco', 'Parada 5', 'Pedragosa Sierra y Av. Italia, Punta del Este', '{5,12}'),
('D 06', 'Disco', 'Fernandez Crespo', 'Av. Daniel Fernandez Crespo 1727', '{3,9}'),
('D 07', 'Disco', 'Soca', 'Av. Dr. Francisco Soca 1318', '{3,9}'),
('D 08', 'Disco', 'Roosevelt', 'Av. Roosevelt y Zelmar Michellini s/n, Maldonado', '{4,11}'),
('D 09', 'Disco', 'Pta Carretas', 'Ellauri 350, local 002. Shopping Punta Carretas', '{5,10}'),
('D 10', 'Disco', 'Camino Maldonado', 'Brig. Gral. Lavalleja 7722, Maldonado', '{3,9}'),
('D 11', 'Disco', '8 de Octubre y Garibaldi', '8 de Octubre 2681', '{4,10}'),
('D 12', 'Disco', 'Curva De Maroñas', '8 de Octubre 4786', '{1,7}'),
('D 13', 'Disco', 'Chucarro', 'Chucarro 1320', '{5,11}'),
('D 14', 'Disco', 'De La Punta', 'Calle 17, entre Gorlero y 24, Punta del Este', '{5,12}'),
('D 15', 'Disco', 'Marcelino Sosa', 'Marcelino Sosa 2706', '{4,10}'),
('D 16', 'Disco', 'Ayacucho', 'Ayacucho 3370', '{5,11}'),
('D 17', 'Disco', 'Calle Maldonado', 'Maldonado 1024', '{6,12}'),
('D 18', 'Disco', 'Solymar', 'Av. Giannattasio Km. 23.500, Solymar', '{2,8}'),
('D 19', 'Disco', 'Atlantida', 'Calle Gral. Artigas s/n, entre 22 y 24, Atlántida', '{1,8}'),
('D 20', 'Disco', '20 De Setiembre', '20 de setiembre 1521', '{3,9}'),
('D 21', 'Disco', 'Ejido', 'Ejido 1530', '{1,7}'),
('D 22', 'Disco', 'Barrios Amorin', 'Barrios Amorín 859', '{1,7}'),
('D 23', 'Disco', 'Medanos', 'Av. Giannattasio km 27.500 y Av. Central, Médanos', '{2,9}'),
('D 24', 'Disco', 'Obligado', 'Obligado 968', '{3,9}'),
('D 25', 'Disco', 'Solano Lopez', 'Francisco Solano López 1680', '{4,10}'),
('D 26', 'Disco', 'Canelones', 'Florencio Sanchez 729, Canelones', '{5,11}'),
('D 27', 'Disco', 'Avda Italia', 'Magariños Cervantes 2052', '{4,10}'),
('D 28', 'Disco', 'La Cabaña', 'Naciones Unidas y Rambla, El Pinar', '{2,9}'),
('DV 01', 'Devoto', 'Malvin', 'H. Irigoyen 1444', '{5,11}'),
('DV 02', 'Devoto', 'Punta Gorda', 'Gral. Paz 1404', '{6,12}'),
('DV 03', 'Devoto', 'Brisas', 'Rivera 4502', '{1,7}'),
('DV 04', 'Devoto', 'Carrasco', 'Bolivia 1413', '{2,8}'),
('DV 05', 'Devoto', 'Shangrila', 'Av. Calcagno s/n, Shangrilá', '{3,8}'),
('DV 06', 'Devoto', 'Santa Mónica', 'Av. Italia 6958 esq. Sta. Mónica', '{6,12}'),
('DV 07', 'Devoto', 'Colón', 'Av. Garzón 1945', '{6,11}'),
('DV 08', 'Devoto', 'San Martín I', 'San Martín 3709', '{6,12}'),
('DV 09', 'Devoto', 'Punta del Este', 'Av. Roosevelt y Parada 10, Punta del Este', '{4,11}'),
('DV 10', 'Devoto', 'Portones', 'Av. Italia 5779', '{1,7}'),
('DV 11', 'Devoto', 'Sayago', 'Cno. Ariel 4626', '{3,10}'),
('DV 12', 'Devoto', 'Pando', 'Ruta 8 km 30.800, Pando', '{4,10}'),
('DV 13', 'Devoto', 'Piriapolis Rambla', 'Rbla. de los Argentinos y Vázquez, Piriápolis', '{1,12}'),
('DV 14', 'Devoto', 'Hiperpiria', 'Av. Piria y Bs. As., Piriápolis', '{4,11}'),
('DV 15', 'Devoto', 'Agraciada', 'Agraciada y Fco. Gómez', '{2,8}'),
('DV 16', 'Devoto', 'San Martín II', 'Av. Gral. San Martín 3083', '{5,10}'),
('DV 18', 'Devoto', 'Las Piedras I', 'Juan A. Lavalleja 671', '{2,8}'),
('DV 19', 'Devoto', 'Prado - Suárez', 'Joaquín Suarez 3458', '{7,10}'),
('DV 20', 'Devoto', 'Arenal Grande', 'Arenal Grande 2006', '{6,11}'),
('DV 21', 'Devoto', '8 de Octubre', '8 de Octubre 3621', '{6,12}'),
('DV 22', 'Devoto', '26 de Marzo', '26 de Marzo esq. Lorenzo Pérez', '{2,8}'),
('DV 23', 'Devoto', 'Coronel Mora', 'Coronel Mora y Agr. Francisco Ros', '{3,9}'),
('DV 24', 'Devoto', 'San Quintín', 'Av. San Quintín 4376', '{1,7}'),
('DV 25', 'Devoto', 'Las Piedras II', 'Av. Dr. Pouey 622', '{2,8}');
